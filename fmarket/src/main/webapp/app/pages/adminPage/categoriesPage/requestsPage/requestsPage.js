System.register(['angular2/core', '../../../../models/requestType', '../../../../services/requestTypeService'], function(exports_1) {
        ...
        execute: function() {
            ...
            RequestsPage = (function () {
                function RequestsPage(requestTypeService) {
                    this.requestTypes = [new requestType_1.RequestType("", "test", 1), new requestType_1.RequestType("", "test", 3), new requestType_1.RequestType("", "test", 2)];
                    this.searchQuery = "";
