...
var ApplicationConstants = (function () {
    ...
    ApplicationConstants.getLocaleDateString = function () {
        var formats = {
            "ar-SA": "dd/MM/yy",
            "bg-BG": "dd.M.yyyy",
            "ca-ES": "dd/MM/yyyy",
    ...
    ApplicationConstants.getLocaleDateRegex = function () {
        var dateFormat = this.getLocaleDateString();
        var separator = this.getLocaleDateSeparator();
        var dateGroups = dateFormat.split(separator);
        var escapedSeparator = separator === '/' ? '\/' : separator;
        var dateRegexp = '^';
        for (var i = 0; i < dateGroups.length; i++) {
            var string = (dateGroups[i].toLowerCase());
            switch (i) {
                case 0:
