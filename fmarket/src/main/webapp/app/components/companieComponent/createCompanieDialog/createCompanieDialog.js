 ...
 */
System.register(["angular2/common", "angular2/core", "../../modalDialog/modalDialog", "../../../models/companieDto"], function(exports_1, context_1) {
    "use strict";
    ...
    var common_1, core_1, modalDialog_1, companieDto_1;
    var CreateCompanieDialog;
    return {
        setters:[
            function (common_1_1) {
                common_1 = common_1_1;
        ...
        execute: function() {
            CreateCompanieDialog = (function (_super) {
            ...
            exports_1("CreateCompanieDialog", CreateCompanieDialog);
        }
    }
});
